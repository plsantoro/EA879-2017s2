...
static const char *const yytname[] =
{
  ...
  "MULTI", "DIVI", "C1", "C2", "NUM", "SOMA", "$accept", "PROGRAMA",
...
#line 39 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
        ...
        printf("Li imagem %d por %d\n", I.width, I.height);
        multi_imagem_linha(&I,(yyvsp[0].fval));
        multi_imagem_coluna(&I,(yyvsp[0].fval));
        multi_imagem_thread(&I,(yyvsp[0].fval));
	struct timeval rt0, rt1, drt; /* Tempo baseada em tempo real */
	gettimeofday(&rt0, NULL);
	multi_imagem_multproc(&I,(yyvsp[0].fval));
...
#line 1268 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 56 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
        printf("Dividindo brilho por %f \n", (yyvsp[0].fval));
        imagem I = abrir_imagem((yyvsp[-2].strval));
        printf("Li imagem %d por %d\n", I.width, I.height);
        divi_imagem(&I,(yyvsp[0].fval));
        salvar_imagem((yyvsp[-4].strval), &I);
        liberar_imagem(&I);
                          }
#line 1281 "y.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 65 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
...
#line 75 "./src/imageprocessing.y" /* yacc.c:1906  */
